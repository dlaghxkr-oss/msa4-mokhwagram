...
import com.msa4mokhwagram.global.errors.constant.CustomErrorCode;
import com.msa4mokhwagram.global.errors.custom.*;
import com.msa4mokhwagram.global.responses.GlobalErrorRes;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GlobalErrorRes> methodArgumentTypeMismatchHandle(MethodArgumentTypeMismatchException e) {
        log.debug(CustomErrorCode.INVALID_PARAMETER_ERROR.name(), String.format("%s : 필드를 확인해 주세요.", e.getMessage()));
